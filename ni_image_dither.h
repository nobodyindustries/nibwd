...
/**
 * Creates and returns a monochromatic (black and white) image that is the result 
 * of the application of the Floyd-Steinberg dithering algorithm to the original 
 * image, which should be grayscale (1 channel).
 * 
 ...
 */
stbi_uc *
ni_image_dither_floydsteinberg_gray2mono(const stbi_uc *img_data, int w, int h);
